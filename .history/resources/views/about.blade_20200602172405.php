...
@section('description', '1:11 Public Relations Agency serves as one of the most vibrant and multifaceted in communications.')
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 d-flex justify-content-center counter-wrap ftco-animate">
                        <div class="block-18 text-center">
                            <div class="text">
                                <strong class="number" data-number="4457">0</strong>
    ...
    <div class="one-half ftco-animate">
        ...
        <div>
            <p> Founded in 2017, 1:11 Public Relations Agency serves as one of the most vibrant and multifaceted in
                ...
                production. Our renowned clients range from: music, sports, TV, technology, entrepreneurial start-up
    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-md-7 heading-section text-center ftco-animate">
                ...
                <p>Our overall vision is to build a solid foundation with each client to gain a thorough understanding
                    of short-term and long-term goals to further execute and maximize on results. We envision
                    articulating your narrative for extended public awareness.

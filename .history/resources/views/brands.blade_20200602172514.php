    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-end">
            <div class="col-md-12 text-center ftco-animate">
                ...
                <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home.</a></span> <span>Brand
                        collaborations</span>
                </p>
            </div>
        </div>
...
<section class="ftco-section">
    <div class="container">
        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-6 d-flex">
                <div class="coach d-sm-flex align-items-stretch">
                    <div class="img order-xl-last" style="background-image: url({{ asset('assets/images/visa.jpg')}});">
                    </div>
                    <div class="text py-4 px-5 ftco-animate">
            ...
            <div class="col-lg-6 d-flex">
                <div class="coach d-sm-flex align-items-stretch">
                    <div class="img order-xl-last" style="background-image: url({{ asset('assets/images/lyft.jpg')}});">
                    </div>
                    <div class="text py-4 px-5 ftco-animate">
                        {{-- <span class="subheading">Head Coach</span> --}}
                        <h3><a href="#">LYFT</a></h3>
            ...
            <div class="col-lg-6 d-flex">
                <div class="coach d-sm-flex align-items-stretch">
                    <div class="img order-xl-last"
                        style="background-image: url({{ asset('assets/images/spotify.jpg')}});"></div>
                    <div class="text py-4 px-5 ftco-animate">
                        {{-- <span class="subheading">Lead Trainer</span> --}}
            ...
            <div class="col-lg-6 d-flex">
                <div class="coach d-sm-flex align-items-stretch">
                    <div class="img" style="background-image: url({{ asset('assets/images/google.gif')}});"></div>
                    <div class="text py-4 px-5 ftco-animate">
                        {{-- <span class="subheading">Head Coach</span> --}}
            ...
            <div class="col-lg-6 d-flex">
                <div class="coach d-sm-flex align-items-stretch">
                    <div class="img" style="background-image: url({{ asset('assets/images/samsung.jpg')}});"></div>
                    <div class="text py-4 px-5 ftco-animate">
                        {{-- <span class="subheading">Lead Trainer</span> --}}

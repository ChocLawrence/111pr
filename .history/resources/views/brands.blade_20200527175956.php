        ...
        <div class="row no-gutters">
            <div class="col-lg-6 d-flex">
                <div class="coach d-sm-flex align-items-stretch">
                    <div class="img-thumbnail" style="background-image: url({{ asset('assets/images/nike.jpg')}});"></div>
            ...
            <div class="col-lg-6 d-flex">
                <div class="coach d-sm-flex align-items-stretch">
                    <div class="img-thumbnail" style="background-image: url({{ asset('assets/images/core.jpg')}});"></div>
                    <div class="text py-4 px-5 ftco-animate">

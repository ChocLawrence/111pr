...
@section('description', 'Contact 1:11 Public Relations Agency.It serves as one of the most vibrant and multifaceted in communications.')
            ...
            <div class="col-md-4 text-md-right contact-info ftco-animate">
                <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <a href="http://111pr.com"  class="white">111-pr.com</a>
                        </div>
                    </div>
                </div>
            </div>

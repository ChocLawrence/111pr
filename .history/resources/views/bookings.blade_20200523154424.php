        ...
        <div class="row">
            <div class="col-md-4">
                <div class="pricing-wrap ftco-animate img"
                    style="background-image: url({{ asset('assets/images/program-1.jpg')}});">
                    <div class="title p-4">
            ...
            <div class="col-md-4">
                <div class="pricing-wrap ftco-animate active img"
                    style="background-image: url({{ asset('assets/images/program-2.jpg')}});">
                    <div class="title p-4">
                        <h3>Weight Lifting</h3>
                        <span>Behind the word mountains</span>
                    </div>
            ...
            <div class="col-md-4">
                <div class="pricing-wrap ftco-animate img"
                    style="background-image: url({{ asset('assets/images/program-3.jpg')}});">
                    <div class="title p-4">
                        <h3>Weight Lifting</h3>
                        <span>Behind the word mountains</span>
                    </div>

...
<section class="ftco-section">
    <div class="container">
        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-6 d-flex">
                <div class="coach d-sm-flex align-items-stretch">
                    <div class="img order-xl-last" style="background-image: url({{ asset('assets/images/lyft.jpg')}});"></div>
                    <div class="text py-4 px-5 ftco-animate">
                        {{-- <span class="subheading">Head Coach</span> --}}
                        <h3><a href="#">LYFT</a></h3>
                    </div>
            ...
            <div class="col-lg-6 d-flex">
                <div class="coach d-sm-flex align-items-stretch">
                    <div class="img order-xl-last" style="background-image: url({{ asset('assets/images/spotify.jpg')}});"></div>
                    <div class="text py-4 px-5 ftco-animate">
                        {{-- <span class="subheading">Lead Trainer</span> --}}

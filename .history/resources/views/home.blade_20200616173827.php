...
@section('description', 'Public Relations Agency aids companies spread their brand.It serves as one of the most vibrant and multifaceted in communications.')
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url({{ asset('assets/images/logo.png')}})">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text text-center">
                    <p class="mb-4">"We contracted 1:11 PR Agency for assistance with a regional event. The agency was executed results in a timely manner prior to our original deadline. Our company was impressed with their ability to align with our precise vision. We look forward to working with 1:11 again."</p>
                    <p class="name"></p>
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text text-center">
                    <p class="mb-4">" Thank you 1:11 for always being efficient and transparent with communications & development. Within a month, 1:11 was able to rebrand for our holiday campaign. If you need creative and timely results, 1:11 is the agency to partner with."</p>
                    <p class="name"></p>
                    <span class="position">Customer</span>
                  </div>
                </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text text-center">
                    <p class="mb-4">"Our social media strategy and consultation was highly effective with not being limited to the COVID-19/pandemic delay. 1:11 PR was able to make revisions and provide creative suggestions when we were in need of a renewed social media plan and crisis management. 1:11 PR are life- savers. Thank you for your services."</p>
                    <p class="name"></p>
                    <span class="position">Customer</span>
                  </div>
                </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url({{ asset('assets/imageslogo.png')}})">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text text-center">
                    <p class="mb-4">"Our parntership with 1:11 PR Agency is everlasting. Each year, we seek assistance from 1:11 as we rollout a renewed project. Thank you for always consulting at our earliest convience and being there for every need."</p>
                    <p class="name"></p>
                    <span class="position">Customer</span>
                  </div>
                </div>
